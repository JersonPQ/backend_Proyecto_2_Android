...
CREATE TABLE tareas (
    ...
    recursosEconomicos decimal(21,6) not null default 0,
    tiempoEstimado decimal(21,6) not null default 0,
    descripcion varchar(300),
...
-- Eliminar la tabla de comentarios
DROP TABLE IF EXISTS comentarios;

-- Eliminar la tabla de publicaciones
